...
const library = [
  {title: 'The Place of Dead Roads', author: 'William S. Burroughs', alreadyRead: true},
  {title: 'On Auntie', author: 'Jonathan Holmes', alreadyRead: false},
...
const myFavouriteMovie = {
  ...
  duration: 107,
  stars: ['George Clooney', 'John Goodman', 'Gillian Welch', 'That Really Depraved Looking Guy']
};
